...
#
# Set OPENSHELL_E2E_KUBE_USE_ENVOY=1 to install or reuse an Envoy Gateway
# controller, enable the chart's Gateway and GRPCRoute, and connect through the
# generated Envoy proxy Service. Resources created by this mode use test-owned
# names and are removed without modifying pre-existing Envoy resources.
#
# Image source:
