...
# sandbox_uid = 1500
# sandbox_gid = 1500
# Operator-mode namespace selection. Exactly one source must be set when
...
# Explicit mapping for platforms where workspace and namespace names differ.
# operator_workspace_namespaces = { "team-a" = "platform-team-a" }
